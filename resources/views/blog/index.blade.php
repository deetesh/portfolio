            ...
            <div class="flex justify-between w-full px-16 py-8">
                ...
                <div>
                    <ul
                        ...
                        <li class="text-left">
                            <x-link href="#experience" reference='a'>
                                Experience
                            </x-link>

                        </li>
                        <li class="text-left">
                            <x-link href="/contact" reference='a'>
                                Contact
                            </x-link>
                ...
                <div>
                    ...
                    <ul class="flex flex-col md:flex-row items-end md:items-center md:space-x-4 space-y-4 md:space-y-0">
                        <li>
                            <x-link reference='a' href="https://github.com/deetesh" target="_blank" aria-label="Github"
                        ...
                        <li>
                            <x-link reference='a' href="https://www.linkedin.com/in/deetesh-goordoyal-8948a5124/" target="_blank" aria-label="linkedin"
                                class="hover:text-blue-600">
        ...
        <section class="flex flex-col items-center justify-center h-screen  -my-20 md:-mt-48 px-8">
            ...
            <div class="flex flex-col items-center justify-center text-center h-screen-half">
                ...
                <img class="md:hidden object-cover w-15 h-40 rounded-full mb-5 ring-2 ring-gray-500/50 ring-offset-[10px]"
                    src="asset('images/profile_pic.jpeg')" alt="Your Name Here" >
                <h1 class="text-5xl sm:text-6xl lg:text-9xl">Deetesh Goordoyal</h1>
                <h2 class="font-light text-4xl sm:text-5xl lg:text-8xl">Software Developer
            </div>
        </section>
        <!-- /Name Section -->
        <!-- image section -->
        <section class="flex items-center justify-between px-8 mb-20 tracking-wider">
            ...
            <div class="flex flex-col w-full md:w-1/3 space-y-12 text-center md:text-left">
                <div class="flex flex-col px-10 md:px-20">
                    ...
                    <br>
                    <span class="text-lg">Web App Full Stack Development</span>
                    <span class="text-lg">Agile Methodology</span>
                    <span class="text-lg">Git Hub Versioning Tool</span>
                    <span class="text-lg">Laravel Framework</span>
                </div>
                ...
                <div class="px-10 md:px-20">
                    ...
                    <a class="text-xl hover:text-blue-600" href="mailto:test@nomail.com">gdeetesh@email.com</a>
                    <p>+230 5860 2475</p>
                </div>
            </div>
            <!-- image -->
